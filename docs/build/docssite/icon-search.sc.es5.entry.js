...
DocsSite.loadBundle('icon-search', ['exports'], function (exports) {
    ...
    var IconSearch = /** @class */ (function () {
        ...
        IconSearch.prototype.watchQuery = function () {
            this.showClearCtrl = (this.query.length > 0) ? true : false;
        };
        IconSearch.prototype.searchListener = function (ev) {
            if (ev.keyCode === 27) {
                this.handleClear();
                return;
            }
        ...
        IconSearch.prototype.handleClear = function () {
            this.hasSearched.emit('');
        };
        IconSearch.prototype.componentWillLoad = function () {
            this.watchQuery();
        };
        ...
        Object.defineProperty(IconSearch, "is", {
            get: function () { return "icon-search"; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(IconSearch, "properties", {
            get: function () {
                return {
                    "autofocus": {
                        "type": String,
        ...
        Object.defineProperty(IconSearch, "events", {
            get: function () {
                return [{
                        "name": "hasSearched",
                        "method": "hasSearched",
        ...
        Object.defineProperty(IconSearch, "listeners", {
            get: function () {
                return [{
                        "name": "keyup",
