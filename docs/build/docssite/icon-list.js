        ...
        return (h("div", { class: "icon-list" },
            ...
            results.icon.length ?
                h("div", { class: "icon-list__wrapper" },
                    ...
                    h("div", { class: "container--small" },
                        h("div", { class: "icon-results" }, results.icon.map(icon => {
                            return h("span", { class: `icon-results__cell ${(this.selectedIcon === icon.name) ? 'active' : ''}`, onClick: (ev) => this.handleIconClick(ev, icon.name), onMouseEnter: (ev) => this.handleIconMouseEnter(ev), onMouseLeave: (ev) => this.handleIconMouseLeave(ev) },
                ...
                h("div", { class: "icon-list__wrapper" },
                    h("div", { class: "icon-list__header-bar" },
                        h("div", { class: "container--small" },
                            h("h4", null, "Logos"))),
                    h("div", { class: "container--small" },
                        h("div", { class: "icon-results" }, results.logo.map(icon => {
                            return h("span", { class: `icon-results__cell ${(this.selectedIcon === icon.name) ? 'active' : ''}`, onClick: (ev) => this.handleIconClick(ev, icon.name), onMouseEnter: (ev) => this.handleIconMouseEnter(ev), onMouseLeave: (ev) => this.handleIconMouseLeave(ev) },
            ...
            h("div", { class: "wrapper" },
                h("div", { class: "container" },
                    h("div", { class: "content" },
                        ...
                        h("p", { class: "lead" }, "Premium designed icons for use in web, iOS, Android, and desktop apps. Support for SVG and web font. Completely open source, MIT licensed."))),
            ...
            activeDownloadLinks = this.selectedIcon.icons.map((name) => {
                ...
                return (h("div", { class: "toast-bar__section" },
                    ...
                    h("div", { class: "btn-group" },
                        ...
                        h("a", { class: "btn btn--gray btn--small", download: `/svg/${name}.svg`, href: `/svg/${name}.svg` },
                    ...
                    this.selectedIcon &&
                        h("div", { class: "toast-bar__details" },
                            h("div", { class: "toast-bar__section", style: { maxWidth: snippetLength + 'px' } },
                                ...
                                h("code", null,
                                    h("span", { class: "hover-highlight", onClick: ev => this.handleCodeClick(ev) },
                                        '<',
                                        h("span", { class: "yellow" }, "ion-icon"),
                                        "\u00A0",
                                        h("span", { class: "orange" }, "name"),
                                        '=',
                                        h("span", { class: "green" }, `"${this.selectedIcon.name}"`),
                                        '>',
                                        '</',
                                        h("span", { class: "yellow" }, "ion-icon"),
                                        '>'))),
