...
DocsSite.loadBundle('icon-list', ['exports'], function (exports) {
    ...
    var LandingPage = /** @class */ (function () {
        ...
        LandingPage.prototype.render = function () {
            ...
            return (h("div", { class: "icon-list" }, h("div", { class: "icon-list__search container--small" }, h("icon-search", { query: this.query, size: "large", autofocus: "autofocus" })), results.icon.length ?
                h("div", { class: "icon-list__wrapper" }, h("div", { class: "icon-list__header-bar" }, h("div", { class: "container--small" }, h("h4", null, "App icons"), h("ul", { class: "toggle" }, h("li", { class: "toggle__item " + ((this.selectedIconType === 'md') ? 'active' : ''), onClick: function (ev) { return _this.handleToggleClick(ev); } }, "Material style"), h("li", { class: "toggle__item " + ((this.selectedIconType === 'ios') ? 'active' : ''), onClick: function (ev) { return _this.handleToggleClick(ev); } }, "iOS style")))), h("div", { class: "container--small" }, h("div", { class: "icon-results" }, results.icon.map(function (icon) { return (h("span", { class: "icon-results__cell " + ((_this.selectedIcon === icon.name) ? 'active' : ''), onClick: function (ev) { return _this.handleIconClick(ev, icon.name); }, onMouseEnter: function (ev) { return _this.handleIconMouseEnter(ev); }, onMouseLeave: function (ev) { return _this.handleIconMouseLeave(ev); } }, h("i", { class: "ion ion-" + _this.selectedIconType + "-" + icon.name }))); }))))
                : '', results.logo.length ?
                h("div", { class: "icon-list__wrapper" }, h("div", { class: "icon-list__header-bar" }, h("div", { class: "container--small" }, h("h4", null, "Logos"))), h("div", { class: "container--small" }, h("div", { class: "icon-results" }, results.logo.map(function (icon) { return (h("span", { class: "icon-results__cell " + ((_this.selectedIcon === icon.name) ? 'active' : ''), onClick: function (ev) { return _this.handleIconClick(ev, icon.name); }, onMouseEnter: function (ev) { return _this.handleIconMouseEnter(ev); }, onMouseLeave: function (ev) { return _this.handleIconMouseLeave(ev); } }, h("i", { class: 'ion ion-' + icon.icon }))); }))))
    ...
    var ToastBar = /** @class */ (function () {
        ...
        ToastBar.prototype.handleCodeClick = function (attrName) {
            var _this = this;
