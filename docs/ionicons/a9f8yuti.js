...
class e {
  ...
  waitUntilVisible(t, e, i) {
    if (this.win.IntersectionObserver) {
      const n = new this.win.IntersectionObserver(t => {
        t[0].isIntersecting && (n.disconnect(), i());
      }, {
        rootMargin: e
      });
      n.observe(t);
  ...
  render() {
    return this.isServer ? t("div", {
      ...
      innerHTML: function(t, e) {
        if (e) {
          const i = t.createDocumentFragment(), n = t.createElement("div");
          n.innerHTML = e, i.appendChild(n);
          for (let t = n.childNodes.length - 1; t >= 0; t--) {
            "SVG" !== n.childNodes[t].nodeName && n.removeChild(n.childNodes[t]);
          }
          // must only have 1 root element
                    const s = n.firstElementChild;
          if (s && "SVG" === s.nodeName && function isValid(t) {
            if (1 === t.nodeType) {
...
function getName(t, e, i, n) {
  return "string" != typeof t ? null : 0 === (t = t.trim().toLowerCase()).length ? null : (
  // default to "md" if somehow the mode wasn't set
  e = e || "md", 
  // if an icon was passed in using the ios or md attributes
  // set the iconName to whatever was passed in
  i && "ios" === e ? t = i.toLowerCase() : n && "md" === e ? t = n.toLowerCase() : t && !/^md-|^ios-|^logo-/.test(t) && (
